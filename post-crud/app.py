...
def get_post_meta(event, context):
    ...
    try:
        data = table.get_item(
            Key={"PK": PK, "SK": SK},
            ProjectionExpression='user_id, post_id, post_title, post_content, points_map, can_share_on, created_at, updated_at',
        ...
        print(json.dumps(data["Item"], indent=4, cls=DecimalEncoder))
